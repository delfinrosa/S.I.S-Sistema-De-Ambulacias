<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroChofer.aspx.cs" Inherits="S.I.S_Sistema_De_Ambulacias.Registro.RegistroChofer" %>
            ...
            <form action="" runat="server">
                <main>
                    <div class="container w-100">
                        <h1 class="text-dark text-center my-5">Chofer</h1>
                    </div>
                            ...
                            &nbsp;<asp:GridView DataKeyNames="ID" ID="datatablesSimple" runat="server" OnLoad="datatablesSimple_Load" AutoGenerateColumns="false" OnRowCancelingEdit="datatablesSimple_RowCancelingEdit" OnRowDeleting="datatablesSimple_RowDeleting" OnRowEditing="datatablesSimple_RowEditing" OnRowUpdating="datatablesSimple_RowUpdating">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Apellidos">
                                        ...
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control" ID="txtApellido" runat="server" Text='<%#Bind("Apellido")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="RFC">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelRFC" runat="server" Text='<%#Bind("RFC")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control" ID="txtRFC" runat="server" Text='<%#Bind("RFC")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Salario">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelSalario" runat="server" Text='<%#Bind("Salario")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control " ID="txtSalario" runat="server" Text='<%#Bind("Salario")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                    ...
                    <div class="container-fluid p-4">
                        <div class="d-block w100">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="text-center mb-4">Registrar Chofer</h2>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxApellido" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-auto">
                                    <h2 class="text-end">
                                        <label for="TxBoxRFC" class="form-label text-dark ">RFC</label>
                                    </h2>
                                </div>
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxRFC" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-auto">
                                    <h2 class="text-end">
                                        <label for="TxBoxIdSalario" class="form-label text-dark ">Salario</label>
                                    </h2>
                                </div>
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxIdSalario" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
