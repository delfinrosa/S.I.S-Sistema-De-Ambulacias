<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroClienteDirecciones.aspx.cs" Inherits="S.I.S_Sistema_De_Ambulacias.Registro.RegistroClienteDirecciones" %>
                            ...
                            &nbsp;<asp:GridView DataKeyNames="ID" ID="datatablesSimple" runat="server" OnLoad="datatablesSimple_Load" AutoGenerateColumns="false" OnRowCancelingEdit="datatablesSimple_RowCancelingEdit" OnRowDeleting="datatablesSimple_RowDeleting" OnRowEditing="datatablesSimple_RowEditing" OnRowUpdating="datatablesSimple_RowUpdating">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="ID Cliente">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelIdCliente" runat="server" Text='<%#Bind("IdCliente")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control" ID="txtIdCliente" runat="server" Text='<%#Bind("IdCliente")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="ID Direccion">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelIdDireccion" runat="server" Text='<%#Bind("IdDireccion")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control" ID="txtIdDireccion" runat="server" Text='<%#Bind("IdDireccion")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="container-fluid p-4">
                        <div class="d-block w100">
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxIDCliente" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-auto">
                                    <h2 class="text-end">
                                        <label for="TxBoxIDDireccion" class="form-label text-dark ">ID Direccion</label>
                                    </h2>
                                </div>
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxIDDireccion" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="d-flex justify-content-end">
                                <asp:Button ID="BtnInsertarClienteDireccion" runat="server" Text="Registrar" Style="color: #fff;" class=" btn border-dark border-2 w-50 bg-dark " OnClick="BtnInsertarClienteDireccion_Click" />
                            </div>
                        </div>
