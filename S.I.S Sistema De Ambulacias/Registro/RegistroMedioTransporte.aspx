<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegistroMedioTransporte.aspx.cs" Inherits="S.I.S_Sistema_De_Ambulacias.Registro.RegistroMedioTrasporte" %>
                ...
                <main>
                            ...
                            &nbsp;<asp:GridView DataKeyNames="ID" ID="datatablesSimple" runat="server" OnLoad="datatablesSimple_Load" AutoGenerateColumns="false" OnRowCancelingEdit="datatablesSimple_RowCancelingEdit" OnRowDeleting="datatablesSimple_RowDeleting" OnRowEditing="datatablesSimple_RowEditing" OnRowUpdating="datatablesSimple_RowUpdating">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Tipo Combustible">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelTipoCombustible" runat="server" Text='<%#Bind("TipoCombustible")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox CssClass="w-100 form-control" ID="txtTipoCombustible" runat="server" Text='<%#Bind("TipoCombustible")%>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Tipo Transporte">
                                        <ItemTemplate>
                                            <asp:Label ID="LabelTipoTransporte" runat="server" Text='<%#Bind("TipoTransporte")%>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                    ...
                    <div class="container-fluid p-4">
                        <div class="d-block w100">
                            <div class="row">
                                <div class="col-12">
                                    <h2 class="text-center mb-4">Registro de Medio de Transporte</h2>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-auto">
                                    <h2 class="text-end">
                                        <label for="TxBoxTipoCombustible" class="form-label text-dark ">Tipo De Combustible</label>
                                    </h2>
                                </div>
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxTipoCombustible" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-2">
                                ...
                                <div class="col-auto">
                                    <h2 class="text-end">
                                        <label for="TxBoxTipoTransporte" class="form-label text-dark ">Tipo De Transporte</label>
                                    </h2>
                                </div>
                                <div class="col-md-7">
                                    <asp:TextBox ID="TxBoxTipoTransporte" runat="server" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="row mb-2">
                            ...
                            <div class="d-flex justify-content-end">
                                <asp:Button ID="BtnInsertarMedioTransporte" runat="server" Text="Registrar" Style="color: #fff;" class=" btn border-dark border-2 w-50 bg-dark " OnClick="BtnInsertarMedioTransporte_Click" />
                            </div>
                        </div>
